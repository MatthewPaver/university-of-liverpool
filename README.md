# University of Liverpool - Computer Science Coursework
...
*Organised by academic year with assignments, projects, and lecture materials*
...
This repository contains coursework, assignments, projects, and study materials from my Computer Science degree at the University of Liverpool. Materials are organised by academic year, covering a wide range of topics including programming, algorithms, software engineering, artificial intelligence, data science, and more.
...
├── Year 1/          # First-year coursework and materials
├── Year 2/          # Second-year coursework and materials
├── Year 3/          # Third-year coursework and materials
└── README.md        # This file
```

Each year contains modules organised by course code (e.g., `COMP105`, `COMP201`), with subdirectories for assignments, lectures, labs, and tutorials.
...
- **Python** — Data science, machine learning, robotics (Years 2-3)
- **SQL** — Database development (Year 2)
- **RDF/SPARQL** — Semantic web technologies (Year 3)
...
- **Software Engineering**: Design patterns, UML, testing, version control
- **Algorithms & Data Structures**: Complexity analysis, optimisation, implementation
- **Machine Learning**: Neural networks, deep learning, probabilistic models
- **Data Science**: Data mining, visualisation, statistical analysis
- **Distributed Systems**: Client-server architectures, RMI, distributed algorithms
- **Database Systems**: SQL, database design, normalisation
- **Semantic Web**: RDF, OWL, SPARQL, knowledge graphs
...
![Webots](https://img.shields.io/badge/Webots-FF6F00?style=flat&logo=robot&logoColor=white)

</div>

### Tools and Frameworks

- **Development**: IntelliJ IDEA, VS Code, Jupyter Notebooks
- **Version Control**: Git, GitHub
- **Databases**: MySQL, PostgreSQL
- **Machine Learning**: TensorFlow, PyTorch, scikit-learn
- **Data Processing**: Apache Spark, pandas, NumPy
- **Visualisation**: Matplotlib, Seaborn
- **Robotics**: Webots simulation platform
- **Semantic Web**: RDFLib, Protégé
...
- **Reference purposes** — To demonstrate academic work and learning progression
...
- **Course Codes**: Module codes follow University of Liverpool's COMP (Computer Science) numbering system
- **File Organisation**: Each module typically contains subdirectories for assignments, lectures, labs, and tutorials
- **Documentation**: Many modules include README files with specific instructions and notes
- **Academic Years**: Materials are organised by academic year (Year 1, Year 2, Year 3)
...
- [University of Liverpool Computer Science Department](https://www.liverpool.ac.uk/computer-science/)
- [Course Documentation](https://www.liverpool.ac.uk/study/undergraduate/courses/computer-science-bsc-hons/)

---

## 📝 License

This repository contains academic coursework and is provided for reference purposes. All materials are subject to academic integrity policies and should be used responsibly.

---

<div align="center">

**Academic coursework repository — University of Liverpool Computer Science**

[⬆ Back to Top](#university-of-liverpool---computer-science-coursework)
